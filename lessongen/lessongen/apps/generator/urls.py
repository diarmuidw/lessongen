...
urlpatterns = patterns("",
    ...
    url(r'^maze/(\d+)/$', 'generator.views.maze', name='gen_maze'),
    url(r'^viewmaze/(\d+)/$', 'generator.views.viewmaze', name='view_maze'),
    url(r'^viewmaze/$', 'generator.views.viewmaze', name='view_maze'),
